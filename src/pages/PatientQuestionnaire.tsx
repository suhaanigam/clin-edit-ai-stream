  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col">
      ...
      <main className="flex-grow flex flex-col items-center justify-center px-4 py-24">
        <h1 className="text-4xl font-bold mb-10 text-center">Patient Questionnaire</h1>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <label className="block mb-2">Phone Number (with Country Code)</label>
              <input
                name="phone"
                type="tel"
                placeholder="e.g., +41 123 456 7890"
            ...
            <div>
              <label className="block mb-2">Which of the following age groups do you belong to?</label>
              <select
                name="ageGroup"
            ...
            <div>
              <label className="block mb-2">How do you currently identify your gender?</label>
              <select
                name="genderIdentity"
              ...
              >
                ...
                <option value="selfDescribe">Let me describe</option>
              </select>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <label className="block mb-2">List any medical treatments you are currently receiving</label>
              <textarea
                name="treatments"
            ...
            <div>
              <label className="block mb-2">Do you have any resulting consequences (e.g., paralysis, blindness)?</label>
              <textarea
                name="consequences"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <label className="block mb-2">What is your relationship status?</label>
              <select
